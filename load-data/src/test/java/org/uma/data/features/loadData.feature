...
Then status 200
Given path '/insertCategoria'
And request {"id":10,"nombre":"Ficción Histórica"}
When method post
Then status 200
Given path '/insertCategoria'
