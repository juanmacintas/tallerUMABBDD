...
Then status 200
Given path '/insertCategoria'
And request {"id":4,"nombre":"Romántica"}
When method post
Then status 200
Given path '/insertCategoria'
...
Then status 200
Given path '/insertCategoria'
And request {"id":8,"nombre":"Policíaca"}
When method post
Then status 200
Given path '/insertCategoria'
...
Then status 200
Given path '/insertCategoria'
And request {"id":10,"nombre":"Ficción Historica"}
When method post
Then status 200
Given path '/insertCategoria'
...
And request {"id":"1",  "titulo":"Los Pilares de la Tierra",  "descripcion":"Descripción de los Pilares de la Tierra",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"1", "nombre":"Planeta"}, "autores" : [{"id":"1"}], "favorite":true,  "informacion": {"id": 1, "isbn": "8466341781", "fechaPublicacion": 2017,     "idioma": "Español", "libro": {"id": 1} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"2",  "titulo":"Los Ritos del Agua",  "descripcion":"Descripción de los Ritos del Agua",  "categoria": {"id":"8","nombre":"Policíaca"},  "editorial": {"id":"1", "nombre":"Planeta"},"autores" : [{"id":"2"}],  "favorite":false,  "informacion": {"id": 2, "isbn": "8408169459", "fechaPublicacion": 2017,     "idioma": "Español", "libro": {"id": 2} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"3",  "titulo":"El guardi�n de recuerdos",  "descripcion":"Descripción de el guardi�n de recuerdos",  "categoria": {"id":"1","nombre":"Ciencia Ficción"},  "editorial": {"id":"1", "nombre":"Planeta"}, "autores" : [{"id":"3"}], "favorite":false,  "informacion": {"id": 3, "isbn": "0000000000", "fechaPublicacion": 2016,     "idioma": "Español", "libro": {"id": 3} }}}
When method post
Then status 200
...
Given path '/insertLibro'
And request {"id":"11",  "titulo":"La Leyenda del Ladrón",  "descripcion":"Descripción de La Leyenda del Ladrón",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"9", "nombre":"Booket"}, "autores" : [{"id":"9"}], "favorite":true,  "informacion": {"id": 11, "isbn": "8408113127", "fechaPublicacion": 2013, "idioma": "Español", "libro": {"id": 11} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"12",  "titulo":"El Nombre de la Rosa",  "descripcion":"Descripción de El Nombre de la Rosa",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"3", "nombre":"DEBOLS!LLO"}, "autores" : [{"id":"10"}], "favorite":false,  "informacion": {"id": 12, "isbn": "8422616467", "fechaPublicacion": 1986, "idioma": "Español", "libro": {"id": 12} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"13",  "titulo":"La legión olvidada",  "descripcion":"Descripción de La legión olvidada",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"2", "nombre":"B DE BOOKS"}, "autores" : [{"id":"11"}], "favorite":false,  "informacion": {"id": 13, "isbn": "8498722411", "fechaPublicacion": 2010, "idioma": "Español", "libro": {"id": 13} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"14",  "titulo":"Triple",  "descripcion":"Descripción de Triple",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"2", "nombre":"B DE BOOKS"}, "autores" : [{"id":"1"}], "favorite":false,  "informacion": {"id": 14, "isbn": "8849759312", "fechaPublicacion": 2014, "idioma": "Español", "libro": {"id": 14} }}}
When method post
Then status 200

Given path '/insertLibro'
And request {"id":"15",  "titulo":"Un Mundo Sin Fin",  "descripcion":"Descripción de Un Mundo Sin Fin",  "categoria": {"id":"10","nombre":"Ficción Historica"},  "editorial": {"id":"2", "nombre":"B DE BOOKS"}, "autores" : [{"id":"1"}], "favorite":false,  "informacion": {"id": 15, "isbn": "8499893732", "fechaPublicacion": 2019, "idioma": "Español", "libro": {"id": 15} }}}
When method post
Then status 200
...
Given path '/insertLibro'
And request {"id":"25",  "titulo":"Orgullo y Prejuicio",  "descripcion":"Descripción de Orgullo y Prejuicio",  "categoria": {"id":"4","nombre":"Romántica"},  "editorial": {"id":"3", "nombre":"DEBOLS!LLO"}, "autores" : [{"id":"16"}], "favorite":false,  "informacion": {"id": 25, "isbn": "6079723956", "fechaPublicacion": 2018, "idioma": "Español", "libro": {"id": 25} }}}
When method post
Then status 200
